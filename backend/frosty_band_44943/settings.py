"""
Django settings for frosty_band_44943 project.
...
ROOT_URLCONF = 'frosty_band_44943.urls'
...
WSGI_APPLICATION = 'frosty_band_44943.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "frosty_band_44943 API",
    "DESCRIPTION": "API documentation for frosty_band_44943 App",
    "VERSION": "v1",
}
